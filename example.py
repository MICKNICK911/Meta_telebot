...
async def main() -> None:
    ...
    url = "https://meta-telebot-alpha.herokuapp.com/"
    admin_chat_id = 5276292355
    port = 5000
    ...
    application = (
        Application.builder().token("5575727673:AAGlCz--3mtDE2R8szewCYr4r-DtCfZ30l4").updater(None).context_types(
            context_types).build()
    )
